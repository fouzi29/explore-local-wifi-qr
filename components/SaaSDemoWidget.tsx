...
import { Smartphone, Laptop, Sparkles, CheckCircle2, Wifi, Lock, Users, ChevronRight } from 'lucide-react';
    ...
    <section className="py-12 bg-slate-950">
      <div className="max-w-5xl mx-auto px-4 space-y-6">
        ...
        <div className="flex items-center justify-center gap-2 pb-2">
          ...
          >
            <Smartphone className="w-4 h-4" /> Guest Smartphone View
          </button>
          <button
        ...
        <div className="flex justify-center">
          ...
          {viewMode === 'mobile' ? (
            <div className="w-full max-w-sm bg-slate-900 rounded-[40px] p-4 border-8 border-slate-800 shadow-2xl relative overflow-hidden">
              
              {/* Phone Notch */}
              <div className="w-32 h-5 bg-slate-800 rounded-b-2xl mx-auto mb-4 flex items-center justify-center">
            ...
            <div className="w-full max-w-3xl glass-card rounded-3xl p-6 border border-slate-800 space-y-6">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-red-500"></div>
                  <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
                  <div className="w-3 h-3 rounded-full bg-green-500"></div>
                  <span className="text-xs font-mono text-slate-400 ml-2">https://yourdomain.com/v/rustic-roaster</span>
                </div>
                <span className="text-xs text-emerald-400 font-bold">Live Simulation</span>
              </div>
